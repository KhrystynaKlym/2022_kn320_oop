...
- Результати виконання завдань:
    ...
    1. Створили першу програму та виконали її
        ```python
    ...
    1. Отримано наступні результати та на скріншоті:
    ...
    1. Створили PythonNoteBook та виконали його

        ![alt text](![alt text](https://github.com/KhrystynaKlym/2022_kn320_oop/raw/main/1_lab/screenshots/1_1_lab.jpg "Результат виконання програми в PythonNoteBook")
